...
#gen_29((sq_size_h,sq_size_w),(mh,mw), line_width, color, background, word_a, word_b, name)
gen.gen_29c((32,32), (100,100), 4, (128,128,128), (255,255,255), "hitomezashi", "pattern", "name")
